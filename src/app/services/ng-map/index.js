...
const getStyle = function(el, styleProp) {
    var y;
    if (el.currentStyle) {
...
*/
const  initMap = function(id) {
    var ctrl = mapControllers[id || 0];
    if (!(ctrl.map instanceof $window.google.maps.Map)) {
      ctrl.initializeMap();
      return ctrl.map;
    } else {
...
* @returns promise
*/
const getMap = function(id, options) {
    options = options || {};
...
* @param mapController {__MapContoller} a map controller
*/
const deleteMap = function(mapCtrl) {
...
* @returns promise
*/
const getGeoLocation = function(string, options) {
    var deferred = $q.defer();
...
*/
const observeAndSet = function(attrName, object) {
